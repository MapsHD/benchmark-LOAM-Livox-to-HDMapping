...
RUN apt-get update && apt-get install -y python3-colcon-common-extensions ros-${ROS_DISTRO}-pcl-ros ros-${ROS_DISTRO}-image-transport ros-${ROS_DISTRO}-cv-bridge libceres-dev git nlohmann-json3-dev libpcl-dev python3-pip
